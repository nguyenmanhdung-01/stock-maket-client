...
const Community = () => {
  ...
  return (
    <div className=" grid grid-cols-4 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-1 sm:grid-cols-1 gap-3 relative bgr-white dark:text-white dark:bg-slate-800">
      <div className=" relative col-span-1 xl:block lg:block md:hidden sm:hidden">
        ...
        {auth.userID !== undefined ? (
          <>
            <Button
              ...
              className={
                "bg-blue-400 hover:bg-blue-600 text-center mb-3 sm:block"
              }
            />
            <ModalV1
              open={open}
            ...
            <Button
              ...
              onClick={() => navigate("/community/bai-viet-cua-ban")}
              className={
                "bg-blue-400 hover:bg-blue-600 text-center mb-3 xl:hidden lg:hidden md:block sm:block"
              }
            />
            <div
              className=" relative w-full max-h-[700px] overflow-y-auto"
              ref={containerRef}
            >
          ...
          <div className=" text-center border border-slate-200 bg-slate-50 dark:bg-gray-800 rounded-lg p-3">
            ...
            <button
              ...
              className=" px-2 py-2 border rounded-md bg-slate-300 dark:text-black hover:opacity-70"
            >
