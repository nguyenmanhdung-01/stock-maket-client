                ...
                {item.news?.length > 0 ? (
                  item.news?.slice(0, 6).map((news) => (
                    <div
                      ...
                      className="grid grid-cols-4 sm:grid-cols-1 w-full bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 cursor-pointer"
                    >
                      <img
                      ...
                      <div className="p-4 leading-normal col-span-3">
                        ...
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 line-clamp-2 break-words">
                          {news.subcontent}{" "}
                          hadjahhjdhajsdgasdsdashdhjasjdhgajsdgahjsgdjhagsdhjahgsjdgaisdwiufyufgushdfugd
                          bidhuiahdias đuihdiahsđía uhiasdiaj
                        </p>
                      </div>
                    </div>
                  ))
